...
- [src/template/dest/{each environments as environment}/{hyphen environment.name}/{each environment.deployments as deployment}/{with deployment.component as component}/{hyphen component.name}/{if (eq component.type 'springboot2_api_service')}/{with component.function_model as service}/src/gen/kotlin/{path service.namespace}/configuration/ElasticsearchConfig.kt.hbs](<./src/template/dest/{each environments as environment}/{hyphen environment.name}/{each environment.deployments as deployment}/{with deployment.component as component}/{hyphen component.name}/{if (eq component.type 'springboot2_api_service')}/{with component.function_model as service}/src/gen/kotlin/{path service.namespace}/configuration/ElasticsearchConfig.kt.hbs>)
